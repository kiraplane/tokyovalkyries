...
export async function generateMetadata({
  ...
  return constructMetadata({
    title: 'Cookie Policy | Tokyo Valkyries Wiki',
    description:
      'How Tokyo Valkyries Wiki uses essential cookies, analytics, and similar technologies.',
    locale,
    pathname: '/cookie',
  });
}
    ...
    <div className="bg-[#061018] py-12 text-[#EAF7FF]">
      <Container className="max-w-3xl space-y-6 px-4">
        ...
        <p className="leading-8 text-[#A8C7D8]">
          Tokyo Valkyries Wiki uses essential cookies and similar technologies
        ...
        <p className="leading-8 text-[#A8C7D8]">
          Questions about this policy can be sent to hello@tokyovalkyries.wiki.
        </p>
      </Container>
    </div>
  );
